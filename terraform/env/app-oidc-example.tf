/*
 OIDC App (Web + SPA + Native) + its groups.
 Duplicate this file to add another OIDC app (e.g., app-oidc-reports.tf)
...
output "oidc_example_client_id"            { value = module.oidc_app_example.client_id }
output "oidc_example_service_principal_id" { value = module.oidc_app_example.service_principal_id }
